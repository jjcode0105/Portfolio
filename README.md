...
| 구분 | 프로젝트 | 분야 | 가장 중요한 구현 포인트 |
| --- | --- | --- | --- |
| **01 / 04** | [검색 품질·광고 성과 진단 자동화 SaaS](#project-01) | B2B SaaS · 자동화 | 비동기 분석, 조직별 권한, 사용량·리포팅 운영 |
| **02 / 04** | [온라인 교육·커머스 통합 플랫폼](#project-02) | Commerce · LMS | 결제·수강권·환불 상태와 운영 관리자 통합 |
| **03 / 04** | [프로젝트 손익·세무 일정 운영 시스템](#project-03) | Internal Tool · FinOps | 프로젝트 손익·현금흐름을 중심으로 한 업무 데이터 모델 |
| **04 / 04** | [검색 성과 데이터 수집·시각화 플랫폼](#project-04) | Data Platform · Dashboard | 외부 데이터 적재·정규화·기간 비교 구조 |

---

<a id="project-01"></a>

## 01 / 04 · 검색 품질·광고 성과 진단 자동화 SaaS

**B2B SaaS** &nbsp;·&nbsp; **업무 자동화** &nbsp;·&nbsp; **분석 리포팅** &nbsp;·&nbsp; **관리자 운영**
...
## 02 / 04 · 온라인 교육·커머스 통합 플랫폼

**이커머스** &nbsp;·&nbsp; **LMS** &nbsp;·&nbsp; **결제·환불** &nbsp;·&nbsp; **운영 관리자**
...
## 03 / 04 · 프로젝트 손익·세무 일정 운영 시스템

**내부 운영 시스템** &nbsp;·&nbsp; **프로젝트 손익** &nbsp;·&nbsp; **정산·증빙** &nbsp;·&nbsp; **경영 대시보드**
...
## 04 / 04 · 검색 성과 데이터 수집·시각화 플랫폼

**데이터 플랫폼** &nbsp;·&nbsp; **외부 API 연동** &nbsp;·&nbsp; **정기 적재** &nbsp;·&nbsp; **성과 대시보드**
